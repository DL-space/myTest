...
;(function(window) {
    ...
    Stack.prototype._init = function() {
        ...
        for(var i = 0; i < this.itemsTotal; ++i) {
            ...
            if( i < this.options.visible ) {
                ...
                item.style.WebkitTransform = item.style.transform = 'translate3d(0px, 0px, ' + parseInt(-1 * 60 * i) + 'px)';
            }
            else {
                item.style.WebkitTransform = item.style.transform = 'translate3d(0,0,-' + parseInt(this.options.visible * 60) + 'px)';
            }
        }
    ...
    Stack.prototype._next = function(action, callback) {
        ...
        onEndAnimation(currentItem, function() {
            ...
            currentItem.style.WebkitTransform = currentItem.style.transform = 'translate3d(0px, 0px, -' + parseInt(self.options.visible * 60) + 'px)';
            ...
            setTimeout(function(item,i) {
                return function() {
                    ...
                    if( preAnimation ) {
                        ...
                        animProps.translateZ = parseInt(-1 * 60 * (i+1));
