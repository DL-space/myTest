...
var i = 0;
var url = "http://www.ece.pku.edu.cn/index.php?m=content&c=index&a=show&catid=502&id=1956";
//初始url
...
function startRequest(x) {
    ...
    http.get(x, function (res) {
        ...
        res.on('end', function () {
            ...
            var time = $('.article .tips').text().trim();
            ...
            var news_title = $('.article h1').text().trim();
            ...
            //下一篇文章的url
            var nextLink=$(".pagenav a:last-child").attr('href');
...
function savedImg($,news_title) {
    $('.article .content p img').each(function (index, item) {
